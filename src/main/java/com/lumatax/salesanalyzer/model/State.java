...
public enum State {
	...
	/* static initializer */
	static {
		Stream.of(values()).forEach(state -> STATES_BY_ABBR.put(state.getAbbreviation(), state));
	}
	...
	public static boolean isAbbreviationValid(String abbr) {
		return STATES_BY_ABBR.containsKey(abbr);
	}
